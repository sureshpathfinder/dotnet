...
public partial class request : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label1.Text += "<br> Server request method" + Request.ServerVariables["request_method"] + "<br>";
        Label1.Text +="<br> Server remote address" + Request.ServerVariables["remote_addr"] + "<br>";
        ...
        Label1.Text += "<br> Browser os Name:  " + Request.Browser.Platform + "<br>";
