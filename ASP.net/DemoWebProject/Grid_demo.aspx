<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Grid_demo.aspx.cs" Inherits="Default3" %>
...
<body>
    ...
    <div>
        ...
        OnRowDeleting ="GridView1_Delete" AutoGenerateColumns="False" Height="199px" Width="418px"
        >
            <Columns>
                ...
                <asp:TemplateField  HeaderText ="EmployeeId" >
                    <ItemTemplate >
                         <asp:Label ID="Lblempno" runat="server" Text='<%# Eval("eid") %>'  ></asp:Label>  
                    </ItemTemplate>
                   <EditItemTemplate >
                         <asp:Label id="LblEmpno" Text ='<%#Eval("eid") %>' runat="server"></asp:Label>
                   </EditItemTemplate> 
                </asp:TemplateField>
