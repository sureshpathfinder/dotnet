...
public partial class Default6 : System.Web.UI.Page
{
    ...
    {
        MyConnection = new SqlConnection("Data Source=SERVER;Initial Catalog=college;User ID=sa");
    ...
    {
        DS.Tables["emp"].Rows[e.RowIndex][1] = ((TextBox)GridView1.Rows[e.RowIndex].FindControl("TextBox2")).Text;
        DS.Tables["emp"].Rows[e.RowIndex][2] = ((TextBox)GridView1.Rows[e.RowIndex].FindControl("TextBox3")).Text;
