Module Module1
    ...
    Sub Main()
        ...
        Console.WriteLine("Array.IndexOf(3)) " & Array.IndexOf(a, 23))

        Console.WriteLine("Array.BinarySearch(a,3) : " & Array.BinarySearch(a, 3))
        ...
        Console.WriteLine("Array.Equals(a(0), a(1)) : " & Array.Equals(a(0), a(1)))
